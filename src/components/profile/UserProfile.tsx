    ...
    <div className="profile-page w-full max-w-4xl mx-auto px-4 py-4 space-y-6 pb-24">
      ...
      <section className="profile-card p-6 sm:p-8 rounded-3xl border shadow-sm space-y-5">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 text-center sm:text-left">
          ...
          {/* Avatar */}
          <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-amber-800 text-white flex items-center justify-center text-3xl font-bold shrink-0 ring-4 ring-amber-700 dark:ring-amber-300 shadow-md overflow-hidden">
            {profile.avatarUrl
